...
| **3–4**   | [2. Model inference performance](chapters/02_performance_model/background.md) | Derive Qwen3 FLOPs, measure prefill/decode latency and tok/s across batch/context, and interpret rooflines |
| **5–6**   | [3. Profile and optimize Qwen3](chapters/03_kernels/README.md) | Use prediction–measurement gaps to select kernel changes and test their model-level effect |
...
* **Kernel work has a stopping point.** Profile and implement the selected fusions and attention mechanisms, retain the GEMM backend, and measure their integrated effect before expanding scope.
